...
//
void sort_list(int q, int my_id) {
...
//Write barrier directive in places neede    
#pragma omp barrier
if (DEBUG) print_list(list, list_size); 
	...
	//for (my_id = 0; my_id < num_threads; my_id++) {
//Write barrier directive in places needed
#pragma omp barrier
...
//adding OpenMP directive parallel to parallelize the code using threads
